<?php
require_once 'db.php';
$sql = "SELECT * FROM 淡水景點 ORDER BY 淡水景點編號";
...
?> <!-- Projects Row -->
            ...
            <div class="col-md-4 img-portfolio">
                <a href="index.php?page=<?=$current?>&mv=<?=$i?>">
                    <img class="img-responsive img-hover" src="<?=$videos[$i]['淡水景點圖片']?>" alt="">
                </a>
                <h3>
                    <a href="portfolio-item.html"><?= $row['淡水景點編號'] ?></a>
                </h3>
                <p><?=$videos[$i]['淡水景點名稱']?></p>
    <h3>
                    <a href="portfolio-item.html"><?= $row['淡水景點編號'] ?></a>
