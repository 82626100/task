<?php
require_once 'db.php';
$sql = "SELECT * FROM 基隆活動 ORDER BY 基隆活動編號";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">你所不知道的基隆活動
                    <small>基隆活動</small>
                </h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a href="blog-post.html">
                    <img class="img-responsive img-hover" src="<?=$videos[$i]['基隆活動圖片']?>" alt="">
                </a>
                 <h3>
                    <a href="portfolio-item.html"><?= $row['基隆活動編號'] ?></a>
                </h3>
                <p><?=$videos[$i]['基隆活動名稱']?></p>
