<?php
require_once 'db.php';
$sql = "SELECT * FROM 瑞芳活動 ORDER BY 瑞芳活動編號";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">你所不知道的瑞芳活動
                    <small>瑞芳活動</small>
                </h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a href="blog-post.html">
                    <img class="img-responsive img-hover" src="<?=$videos[$i]['瑞芳活動圖片']?>" alt="">
                </a>
                 <h3>
                    <a href="portfolio-item.html"><?= $row['瑞芳活動編號'] ?></a>
                </h3>
                <p><?=$videos[$i]['瑞芳活動名稱']?></p>
