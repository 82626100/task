<?php
require_once 'db.php';
$sql = "SELECT * FROM 基隆景點 ORDER BY 基隆景點編號";
...
?> <!-- Projects Row -->
            ...
            <div class="col-md-4 img-portfolio">
                <a href="index.php?page=<?=$current?>&mv=<?=$i?>">
                    <img class="img-responsive img-hover" src="<?=$videos[$i]['基隆景點圖片']?>" alt="">
                </a>
                <h3>
                    <a href="portfolio-item.html"><?= $row['基隆景點編號'] ?></a>
                </h3>
                <p><?=$videos[$i]['基隆景點名稱']?></p>
    <h3>
                    <a href="portfolio-item.html"><?= $row['基隆景點編號'] ?></a>
